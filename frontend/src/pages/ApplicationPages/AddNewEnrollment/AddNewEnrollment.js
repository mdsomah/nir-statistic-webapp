...
import "./AddNewEnrollment.css";

// React Sweet Alert Initializtion
const MySwal = withReactContent(Swal);

const AddNewEnrollment = ({ socket }) => {
  ...
  // Post New Enrollment Ddata
  const handleSubmitData = (e) => {
    e.preventDefault();
    if (isAuthenticated) {
      axios.post("http://localhost:5000/datas", enrollmentData).then((response) => {
        // console.log(response);
        newDataSuccessLink();
        window.location.reload(false);
      });
      socket.emit("newEnrollmentPost", { enrollmentData, user, socketID: socket.id });
    }
  };
  ...
  return (
    <React.Fragment>
      ...
      <div id="add-new-enrollment-wrapper">
        <h5>Add New Enrollment Data</h5>
          ...
          >
            <div className="last-name pure-control-group ">
              ...
              <input
                ...
                value={enrollmentData.lastName = data.lastName}
                onChange={(e) =>
                  setEnrollmentData({
                    ...enrollmentData,
            ...
            <div className="first-name pure-control-group ">
              ...
              <input
                ...
                value={enrollmentData.firstName = data.firstName}
                onChange={(e) =>
                  setEnrollmentData({
                    ...enrollmentData,
            ...
            <div className="middle-name pure-control-group">
              ...
              <input
                ...
                value={enrollmentData.middleName = data.middleName}
                onChange={(e) =>
                  setEnrollmentData({
                    ...enrollmentData,
            ...
            <div className="title pure-control-group">
              ...
              <input
                ...
                value={enrollmentData.title = data.title}
                onChange={(e) =>
                  setEnrollmentData({
                    ...enrollmentData,
            ...
            <div className="county-name pure-control-group">
              ...
              <select
                ...
                value={enrollmentData.county = data.county}
                onChange={(e) =>
                  setEnrollmentData({ ...enrollmentData, county: e.target.value })
                }
              >
            ...
            <div className="center-name pure-control-group">
              ...
              <select
                ...
                className="pure-u-23-24"
                value={enrollmentData.enrollmentCenter = data.enrollmentCenter}
                onChange={(e) =>
                  setEnrollmentData({
                    ...enrollmentData,
            ...
            <div className="data pure-control-group pure-u-1-3">
              ...
              <input
                ...
                className="pure-u-23-24"
                required
                value={enrollmentData.totalMales}
                onChange={(e) =>
                  setEnrollmentData({
                    ...enrollmentData,
            ...
            <div className="data pure-control-group pure-u-1-3">
              <input
                ...
                className="pure-u-23-24"
                required
                value={enrollmentData.totalFemales}
                onChange={(e) =>
                  setEnrollmentData({
                    ...enrollmentData,
            ...
            <div className="data pure-control-group pure-u-1-3">
              <input
                ...
                className="pure-u-23-24"
                value={
                  (enrollmentData.totalDatas =
                    Number(enrollmentData.totalMales) +
                    Number(enrollmentData.totalFemales))
                }
                onChange={(e) =>
                  setEnrollmentData({
                    ...enrollmentData,
